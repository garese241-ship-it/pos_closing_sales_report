...
class PosSession(models.Model):
    ...
    normal_sales_total = fields.Monetary(
    ...
    closing_datetime_display = fields.Char(
    ...
    def _send_closing_sales_report(self):
        ...
        super(PosSession, self).write({
            'pos_sales_total': pos_total,
            'normal_sales_total': normal_total,
            'grand_total': grand_total,
            'closing_datetime_display': closing_datetime_display,
        })
